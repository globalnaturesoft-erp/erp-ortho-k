  ...
  scope "(:locale)", locale: /en|vi/ do
      ...
      resources :products do
        collection do
          ...
          get 'delivery_report_xlsx'
          get 'delivery_report_case_0_xlsx'
          get 'delivery_report_case_1_xlsx'
          get 'delivery_report_case_2_xlsx'
          get 'delivery_report_case_3_xlsx'
          ...
          put 'set_deleted'
			...
			resources :accountings do
				collection do
					...
					get 'report_statistical_donated_goods'
					...
					get 'report_customer_arising_liabilities_by_monthly'
					post 'report_customer_arising_liabilities_by_monthly_table'
					get 'report_customer_arising_liabilities_by_monthly_xlsx'
				end
			end
          ...
          get 'report_custom_product_xlsx'
			...
			resources :sales do
				collection do
					...
					get 'report_product_return_by_pstate_xlsx'
				end
			end
